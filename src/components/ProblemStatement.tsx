  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-[#23263A] mb-8">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <p className="text-xl text-gray-700 italic leading-relaxed">
            "73% of creative professionals report having 3+ active passion projects, 
            yet 89% of productivity tools are built for single-focus users."
          </p>
          <p className="text-sm text-gray-500 mt-4">Source: Creative Professional Survey, 2024</p>
        </div>
      </div>
    </section>
  );
